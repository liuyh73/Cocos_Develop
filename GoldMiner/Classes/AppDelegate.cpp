...
bool AppDelegate::applicationDidFinishLaunching() {
	...
	for (int i = 0; i < 8; i++) {
		std::string mouseFramesName = "";
		mouseFramesName = mouseFramesName+"gem-mouse-" + char(i+'0') + ".png";
	...
	for (int i = 0; i < 7; i++) {
		std::string diamondFramesName = "";
		diamondFramesName = diamondFramesName + "pulled-diamond-" + char(i + '0') + ".png";
		diamondAnimation->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName(diamondFramesName));
	}
	diamondAnimation->setDelayPerUnit(0.3);
	AnimationCache::getInstance()->addAnimation(diamondAnimation, "diamondAnimate");
